const homeHtml = ` <section>
 ...
 section id = "result-output" >
   <p>
        Reading...
        </p> <
   /section>`;

const flashCardHtml = () => `<div class="flash-card-page-container">
  </div>`;
  
const flashCardSnippet = (question, answer) => `<div id="flash-card" class="card">
      <h1 id="q" class="">${question}</h1>
      <hi id="a" class="hide">${answer}</h1>
    </div>`
