 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class f extends Error{constructor(t){super(`[GoogleGenerativeAI Error]: ${t}`)}}class C extends f{constructor(t,n){super(t),this.response=n}}class Y extends f{constructor(t,n,s,i){super(t),this.status=n,this.statusText=s,this.errorDetails=i}}class E extends f{}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function B(e,t,n,s){const i=await O(t,m.STREAM_GENERATE_CONTENT,e,!0,JSON.stringify(n),s);return ce(i)}async function P(e,t,n,s){const o=await(await O(t,m.GENERATE_CONTENT,e,!1,JSON.stringify(n),s)).json();return{response:A(o)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
