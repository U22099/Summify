 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class f extends Error{constructor(t){super(`[GoogleGenerativeAI Error]: ${t}`)}}class C extends f{constructor(t,n){super(t),this.response=n}}class K extends f{constructor(t,n,s,i){super(t),this.status=n,this.statusText=s,this.errorDetails=i}}class E extends f{}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V="https://generativelanguage.googleapis.com",J="v1beta",W="0.20.0",z="genai-js";var m;(function(e){e.GENERATE_CONTENT="generateContent",e.STREAM_GENERATE_CONTENT="streamGenerateContent",e.COUNT_TOKENS="countTokens",e.EMBED_CONTENT="embedContent",e.BATCH_EMBED_CONTENTS="batchEmbedContents"})(m||(m={}));class X{constructor(t,n,s,i,o){this.model=t,this.task=n,this.apiKey=s,this.stream=i,this.requestOptions=o}toString(){var t,n;const s=((t=this.requestOptions)===null||t===void 0?void 0:t.apiVersion)||J;let o=`${((n=this.requestOptions)===null||n===void 0?void 0:n.baseUrl)||V}/${s}/${this.model}:${this.task}`;return this.stream&&(o+="?alt=sse"),o}}function Q(e){const t=[];return e!=null&&e.apiClient&&t.push(e.apiClient),t.push(`${z}/${W}`),t.join(" ")}async function Z(e){var t;const n=new Headers;n.append("Content-Type","application/json"),n.append("x-goog-api-client",Q(e.requestOptions)),n.append("x-goog-api-key",e.apiKey);let s=(t=e.requestOptions)===null||t===void 0?void 0:t.customHeaders;if(s){if(!(s instanceof Headers))try{s=new Headers(s)}catch(i){throw new E(`unable to convert customHeaders value ${JSON.stringify(s)} to Headers: ${i.message}`)}for(const[i,o]of s.entries()){if(i==="x-goog-api-key")throw new E(`Cannot set reserved header name ${i}`);if(i==="x-goog-api-client")throw new E(`Header name ${i} can only be set using the apiClient field`);n.append(i,o)}}return n}async function ee(e,t,n,s,i,o){const a=new X(e,t,n,s,o);return{url:a.toString(),fetchOptions:Object.assign(Object.assign({},se(o)),{method:"POST",headers:await Z(a),body:i})}}async function O(e,t,n,s,i,o={},a=fetch){const{url:r,fetchOptions:d}=await ee(e,t,n,s,i,o);return te(r,d,a)}async function te(e,t,n=fetch){let s;try{s=await n(e,t)}catch(i){ne(i,e)}return s.ok||await ie(s,e),s}function ne(e,t){let n=e;throw e instanceof K||e instanceof E||(n=new f(`Error fetching from ${t.toString()}: ${e.message}`),n.stack=e.stack),n}async function ie(e,t){let n="",s;try{const i=await e.json();n=i.error.message,i.error.details&&(n+=` ${JSON.stringify(i.error.details)}`,s=i.error.details)}catch{}throw new K(`Error fetching from ${t.toString()}: [${e.status} ${e.statusText}] ${n}`,e.status,e.statusText,s)}function se(e){const t={};if((e==null?void 0:e.signal)!==void 0||(e==null?void 0:e.timeout)>=0){const n=new AbortController;(e==null?void 0:e.timeout)>=0&&setTimeout(()=>n.abort(),e.timeout),e!=null&&e.signal&&e.signal.addEventListener("abort",()=>{n.abort()}),t.signal=n.signal}return t}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function P(e,t,n,s){const i=await O(t,m.STREAM_GENERATE_CONTENT,e,!0,JSON.stringify(n),s);return ce(i)}async function B(e,t,n,s){const o=await(await O(t,m.GENERATE_CONTENT,e,!1,JSON.stringify(n),s)).json();return{response:A(o)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
